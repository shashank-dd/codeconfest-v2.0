...
import './App.css';
import m from "./imgs/swarajya.avif"
import t from "./imgs/Trees.png"
...
function App() {
  return (<div>
      ...
      <nav>
  <ul>
    <li><Link className='k' to="/images">IMAGES</Link></li>
    <li><Link className='k' to="/statue">ABOUT STATUE</Link></li>
    <li><Link className='k' to="/history">HISTORY</Link></li>
    ...
    <div class="slider background" >
      ...
      <img src={t} class="foreground"></img>
